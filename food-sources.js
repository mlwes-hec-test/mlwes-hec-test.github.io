...
(function(global){
  ...
  function toFoodRecord(item,source,variant=null){
    ...
    for(const key of ['sourceProvenance','canonicalEvidence','evidenceConflicts','currentState','choiceFamilyAliases'])if(entity[key]!==undefined||item[key]!==undefined)record[key]=clone(entity[key]??item[key]);
