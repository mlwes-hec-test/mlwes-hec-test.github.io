...
(function(global){
  ...
  function toFoodRecord(item,source,variant=null){
    ...
    return {
      ...
      defaultAmount:1,defaultUnit:unitKey,servingDefaultUnit:unitKey,lockedServingUnit:unitKey,units:{[unitKey]:1},unitLabels:{[unitKey]:unitLabel},serving:entity.standardServingLabel,
