...
function foodMultiplier(food,amount,unit){const multiplier=Number(unitOptions(food)[unit]);return multiplier>0?Math.max(0,n(amount))*multiplier:NaN;}
