...
(function(global){
  ...
  function commercialIdentityMembership(entity,food){
    ...
    return {matches:!!matches,reason:matches?'verified-commercial-identity':'no-verified-commercial-identity'};
  }
